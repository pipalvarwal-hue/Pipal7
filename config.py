...
DB_URI = os.environ.get("DB_URI", "mongodb+srv://ContentSave78:<ContentSave78>@cluster0.bi9jils.mongodb.net/?appName=Cluster0") # Warning - Give Db uri in deploy server environment variable, don't give in repo.
